...
public class Real_time_data_updates extends AbstractNatExample {
	...
	public Control createExampleControl(Composite parent) {
		...
		GlazedListsGridLayer glazedListsGridLayer = new GlazedListsGridLayer(eventList, RowDataListFixture.getPropertyNames(),
		...
		selectionLayer.setSelectionModel(new RowSelectionModel(selectionLayer, bodyDataProvider, new IRowIdAccessor() {

			public Serializable getRowId(Object rowObject) {
				return ((RowDataFixture) rowObject).getSecurity_id();
			}
			...
			Display.getDefault().asyncExec(new Runnable(){
				public void run() {
					try {
						...
						if (removeElements) {
							final RowDataFixture remove = (RowDataFixture) eventList.remove(elementIndexToRemove);
