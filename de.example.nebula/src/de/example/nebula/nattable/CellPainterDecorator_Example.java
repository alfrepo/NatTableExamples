...
public class CellPainterDecorator_Example extends AbstractNatExample {
	...
	private void createNatTable(Composite parent, boolean paintDecorationDependent) {
		...
		natTable.addConfiguration(new TableDecorationConfiguration2(paintDecorationDependent));
		natTable.addConfiguration(new TableDecorationConfiguration3(paintDecorationDependent));
		natTable.configure();
...
class TableDecorationConfiguration2 extends AbstractRegistryConfiguration  {

	private boolean paintDecorationdepentend;
	
	public TableDecorationConfiguration2(boolean paintDecorationDependent) {
...
class TableDecorationConfiguration3 extends AbstractRegistryConfiguration  {
	
	private boolean paintDecorationdepentend;
	
	public TableDecorationConfiguration3(boolean paintDecorationDependent) {
		this.paintDecorationdepentend = paintDecorationDependent;
	}
