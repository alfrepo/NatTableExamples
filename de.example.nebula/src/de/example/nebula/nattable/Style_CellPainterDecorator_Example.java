...
public class Style_CellPainterDecorator_Example extends AbstractNatExample {

	public static void main(String[] args) throws Exception {
		StandaloneNatExampleRunner.run(new Style_CellPainterDecorator_Example());
	}
	...
	private List createNumberValuesList() {
...
class TableDecorationConfiguration extends AbstractRegistryConfiguration  {
	...
	public void configureRegistry(IConfigRegistry configRegistry) {
		...
		configRegistry.registerConfigAttribute(
				...
				DisplayMode.NORMAL, Style_CellPainterDecorator_Example.COLUMN_ONE_LABEL);
		...
		configRegistry.registerConfigAttribute(
				...
				new CellPainterDecorator(
						...
						new ImagePainter(GUIHelper.getImage("plus")), 
						this.paintDecorationdepentend),
				DisplayMode.NORMAL, Style_CellPainterDecorator_Example.COLUMN_TWO_LABEL);
		...
		configRegistry.registerConfigAttribute(
				...
				new CellPainterDecorator(
						...
						new ImagePainter(GUIHelper.getImage("plus")), 
						this.paintDecorationdepentend),
				DisplayMode.NORMAL, Style_CellPainterDecorator_Example.COLUMN_THREE_LABEL);
		...
		configRegistry.registerConfigAttribute(
				...
				new CellPainterDecorator(
						...
						new ImagePainter(GUIHelper.getImage("plus")), 
						this.paintDecorationdepentend),
				DisplayMode.NORMAL, Style_CellPainterDecorator_Example.COLUMN_FOUR_LABEL);
		...
		configRegistry.registerConfigAttribute(
				...
				new CellPainterDecorator(
						...
						new ImagePainter(GUIHelper.getImage("plus")), 
						this.paintDecorationdepentend),
				DisplayMode.NORMAL, Style_CellPainterDecorator_Example.COLUMN_FIVE_LABEL);
		...
		configRegistry.registerConfigAttribute(
				...
				new CellPainterDecorator(
						...
						new ImagePainter(GUIHelper.getImage("plus")), 
						this.paintDecorationdepentend),
				DisplayMode.NORMAL, Style_CellPainterDecorator_Example.COLUMN_SIX_LABEL);
		...
		configRegistry.registerConfigAttribute(
				...
				new CellPainterDecorator(
						...
						new ImagePainter(GUIHelper.getImage("plus")), 
						this.paintDecorationdepentend),
				DisplayMode.NORMAL, Style_CellPainterDecorator_Example.COLUMN_SEVEN_LABEL);
		...
		configRegistry.registerConfigAttribute(
				...
				new CellPainterDecorator(
						...
						new ImagePainter(GUIHelper.getImage("plus")), 
						this.paintDecorationdepentend),
				DisplayMode.NORMAL, Style_CellPainterDecorator_Example.COLUMN_EIGHT_LABEL);
