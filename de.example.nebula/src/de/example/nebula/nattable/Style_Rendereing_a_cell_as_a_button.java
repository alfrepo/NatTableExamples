...
public class Style_Rendereing_a_cell_as_a_button extends AbstractNatExample {
	...
	public static void main(String[] args) throws Exception {
		StandaloneNatExampleRunner.run(600, 400, new Style_Rendereing_a_cell_as_a_button());
	}
	...
	public Control createExampleControl(Composite parent) {
		...
		natTable.addConfiguration(new ButtonClickConfiguration(buttonPainter));
...
//
//			ListDataProvider dataProvider = gridLayer.getBodyDataProvider();
//
