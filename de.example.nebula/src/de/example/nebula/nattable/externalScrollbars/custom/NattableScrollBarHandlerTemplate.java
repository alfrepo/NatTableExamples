...
public abstract class NattableScrollBarHandlerTemplate implements Listener {

	public static final int DEFAULT_OFFSET = 1;
	protected final NattableViewportLayer viewportLayer;
	...
	//changes
	boolean mayModifyScrollbar = false;

	public NattableScrollBarHandlerTemplate(NattableViewportLayer viewportLayer, ScrollBar scrollBar, boolean mayModifyScrollbar) {
		this.viewportLayer = viewportLayer;
		this.scrollableLayer = viewportLayer.getScrollableLayer();
		this.scrollBar = scrollBar;
		this.scrollBar.addListener(SWT.Selection, this);
		
		this.mayModifyScrollbar = mayModifyScrollbar;
	}
	...
	void adjustScrollBar() {
		...
		//XXX this is the point, where the scrollbar is modified by the layer
		if(mayModifyScrollbar){
