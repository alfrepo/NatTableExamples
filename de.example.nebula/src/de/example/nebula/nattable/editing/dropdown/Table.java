...
public class Table extends AbstractNatExample {
	...
	private IDataProvider setupBodyDataProvider() {
		final List people = Arrays.asList(
				new MyPerson(100, "Mickey Mouse", new Date(1000000), true, 98), 
				new MyPerson(110, "Batman", new Date(2000000), false, 99), 
				new MyPerson(120, "Bender", new Date(3000000), false, 99), 
				new MyPerson(130, "Cartman", new Date(4000000), false, 99), 
				new MyPerson(140, "Dogbert", new Date(5000000), true, 1));
